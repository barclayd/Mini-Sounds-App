...
- (void)stateChanged:(BBCSMPState*)state
{
    ...
    if (_state == BBCSMPStatePlaying && !_playSuccessSent) {
        [_AVMonitoringClient trackPlaySuccessWithVPID:_lastRequestedItemTracker.vpidForCurrentItem AVType:_lastRequestedItemTracker.avType  streamType:_lastRequestedItemTracker.streamType supplier:_lastRequestedItemTracker.supplier transferFormat:_lastRequestedItemTracker.transferFormat];
